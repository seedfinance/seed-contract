...
contract RewardToken is ERC20, ERC20Detailed, ERC20Capped, Governable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "SEED::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "SEED::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "SEED::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "SEED::_writeCheckpoint: block number exceeds 32 bits"
            );
